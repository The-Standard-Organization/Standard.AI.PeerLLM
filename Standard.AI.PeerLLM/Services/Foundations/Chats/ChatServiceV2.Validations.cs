...
namespace Standard.AI.PeerLLM.Services.Foundations.Chats
{
    ...
    {
        private static void ValidateOnStartChat(ChatSessionConfigV2 chatSessionConfig)
        {
        ...
        private static void ValidateChatSessionConfigNotNull(ChatSessionConfigV2 chatSessionConfig)
        {
