    ...
    public partial class ChatClientTests
    {
            ...
            Xeption validationException)
        {
            ...
            this.chatServiceMock.Setup(service =>
                service.StartChatAsync(It.IsAny<ChatSessionConfigV2>(), It.IsAny<CancellationToken>()))
                    .ThrowsAsync(validationException);

            // when
            ValueTask<Guid> startChatTask =
                this.chatClientV2.StartChatAsync(someChatSessionConfig, cancellationToken);
