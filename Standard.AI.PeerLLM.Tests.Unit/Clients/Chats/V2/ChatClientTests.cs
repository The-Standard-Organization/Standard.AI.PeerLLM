...
namespace Standard.AI.PeerLLM.Tests.Unit.Clients.Chats.V2
{
    ...
    {
        private readonly Mock<IChatServiceV2> chatServiceMock;
        private readonly ChatClientV2 chatClientV2;

        public ChatClientTests()
        {
            this.chatServiceMock = new Mock<IChatServiceV2>();
            this.chatClientV2 = new ChatClientV2(chatService: this.chatServiceMock.Object);
        }
