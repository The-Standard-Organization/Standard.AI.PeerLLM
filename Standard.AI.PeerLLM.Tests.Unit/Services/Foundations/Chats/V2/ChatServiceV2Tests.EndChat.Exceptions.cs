...
namespace Standard.AI.PeerLLM.Tests.Unit.Services.Foundations.Chats.V2
{
    public partial class ChatServiceV2Tests
    {
        ...
        public async Task ShouldThrowDependencyValidationExceptionOnEndChatIfBadRequestErrorOccurredAsync()
        {
            ...
            // when
            ValueTask<string> endChatTask = this.chatServiceV2.EndChatAsync(someConversationId, cancellationToken);
        ...
        [Fact]
        public async Task ShouldThrowDependencyValidationExceptionOnEndChatIfUnauthorizedOccurredAsync()
        {
            // given
            Guid someConversationId = Guid.NewGuid();
            string someText = GetRandomString();
